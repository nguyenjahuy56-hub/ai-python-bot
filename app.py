...
SUNWIN_SAMPLE_DECAY = 0.6     # Độ suy giảm trọng số mẫu cũ (1.0 là ko giảm. 0.85 là tối ưu nhất: 100% -> 85% -> 72%...)

# ♦️ THÔNG SỐ AI CHO HITCLUB MD5
HITCLUB_MAX_SAMPLES_TONG = 7    
HITCLUB_MAX_SAMPLES_DICE = 8   
HITCLUB_WEIGHT_TONG = 0.40      
HITCLUB_WEIGHT_DICE = 0.60      
HITCLUB_SAMPLE_DECAY = 0.6  
