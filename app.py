...
SUNWIN_MAX_SAMPLES_TONG = 20     # Số lần quét lại lịch sử cho TỔNG 
SUNWIN_MAX_SAMPLES_DICE = 30    # Số lần quét lại lịch sử cho BỘ XÚC XẮC 
