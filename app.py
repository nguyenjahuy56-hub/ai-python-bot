...
SUNWIN_L1_MAX_SAMPLES_TONG = 8 
SUNWIN_L1_MAX_SAMPLES_DICE = 8  
SUNWIN_L1_WEIGHT_TONG = 0.45      
SUNWIN_L1_WEIGHT_DICE = 0.55      
SUNWIN_L1_DECAY = 0.85    

# --- LOGIC 2: ĐỌC VỊ KHI VÀO FORM BỆT ---
SUNWIN_L2_MAX_SAMPLES_TONG = 7  
SUNWIN_L2_MAX_SAMPLES_DICE = 10
SUNWIN_L2_WEIGHT_TONG = 0.30
SUNWIN_L2_WEIGHT_DICE = 0.70
SUNWIN_L2_DECAY = 0.60
